...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="section2">
          <form id="order-form">
            ...
            <input type="tel" id="cellphone" name="cellphone" required pattern="(\+?\d{1,4}[\s\-]?)?(\(?\d{2,3}\)?[\s\-]?)?[\d\s\-]{7,10}" title="Please enter a valid phone number">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Set up auto-refresh every 5 seconds (optional)
